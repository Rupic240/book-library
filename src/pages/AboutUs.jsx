...
const AboutUs = () => {
  return (
    <div className="relative w-full h-screen flex items-center justify-around p-[5%] bg-gray-500 max-md:justify-center">
      <div className="w-[450px] max-md:z-30 max-sm:grid max-sm:place-items-center">
